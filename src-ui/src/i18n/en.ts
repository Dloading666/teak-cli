export const en = {
  ...
  'explorer.search_empty': 'No matching files',
  ...
  'editor.saved': 'Saved',
  'editor.save_error': 'Save failed',
  'editor.loading': 'Loading…',
  'editor.too_large': 'File too large to edit here',
  'editor.binary': 'This file cannot be opened as text',
  'editor.find': 'Find',
  'editor.find_none': 'No results',
  'editor.find_next': 'Next',
  'editor.find_prev': 'Previous',
  'editor.goto': 'Go to line',
  'editor.wrap': 'Wrap',
  'editor.nowrap': 'No Wrap',
  'editor.copied': 'Path copied',
  'editor.modified': 'Modified',
  'editor.untracked': 'Untracked',
  'editor.spaces': 'Spaces: {size}',
  'editor.tab_size': 'Tab Size: {size}',
  'editor.plain_text': 'Plain Text',
  'editor.no_preview': 'No preview for this file',
  'editor.preview_error': 'Could not display this file',
  'editor.preview_fit': 'Fit',
  ...
  'collab.member.session_select': 'Select an existing session',
  'collab.member.session_manual': 'Enter a session ID manually',
  'collab.member.session_new_waiting': 'Creating a real Grok session and waiting for its native ID…',
  'collab.member.session_new_bound': 'The new session is created and bound. Save the team to keep it.',
